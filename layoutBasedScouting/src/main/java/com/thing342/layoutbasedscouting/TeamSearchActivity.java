...
public class TeamSearchActivity extends SherlockActivity
{
    ...
    private void handleIntent(Intent intent)
    {
        ...
        emptyText.setTextAppearance(getBaseContext(), android.R.style.TextAppearance_Large);
        ...
        if (Intent.ACTION_SEARCH.equals(intent.getAction())) {
            ...
            results.clear();
            for (FRCTeam team : app.teamsList)
                if (Integer.toString(team.number).startsWith(query)) results.add(team);
